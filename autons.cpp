...
void defaultAuton() {
    ...
    chassis.moveToPose(0, 16.5, 0, 1000, {.maxSpeed = 600});
    chassis.turnToHeading(25, 1000);
    chassis.moveToPoint(5, 37.5, 2000, {.maxSpeed = 25});
    chassis.moveToPose(20, 46, 90, 3000, {.maxSpeed = 127});
    pros::delay(1800);
    scraper.set_value(true);
    pros::delay(400);
    chassis.moveToPoint(12, 48, 2000, {.maxSpeed = 999});
    pros::delay(2000);
    scraper.set_value(false);
